...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('messages.upsert', async chatUpdate => {
        ...
        require("./HideFolder")(XeonBotInc, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
...
let buttonMessage = {
document: fs.readFileSync('./MyGallery/theme/stefanie.xlsx'),
mimetype: docs,
...
let buttonMessage = {
document: fs.readFileSync('./MyGallery/theme/cheems.xlsx'),
mimetype: docs,
